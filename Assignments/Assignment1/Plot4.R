...
plot(analysisData$Global_active_power ~ analysisData$DateTime, type="l", xlab="", ylab="Global Active Power (in Kilowatts)", ylim=c(0,6000),yaxt="n")
axis(2, at=seq(0,6000,1000), labels=c("0","","2","","4","","6"))

## Plot upper right panel
plot(analysisData$Voltage ~ analysisData$DateTime, type="l", xlab="DateTime", ylab="Voltage")
...
plot(analysisData$Global_reactive_power ~ analysisData$DateTime, type="l", xlab="DateTime", ylab="Global Reactive Power")
